...
# Set environment variable to simulate button click
os.environ["STREAMLIT_TEST"] = "1"

# We will mock streamlit entirely
import importlib.util

spec = importlib.util.spec_from_file_location("st_mock", "c:/D_Drive/Stock/Codewithgoogle/StockswithDryVolume/vdu_scanner/streamlit_mock.py")
st_mock = importlib.util.module_from_spec(spec)
sys.modules["streamlit"] = st_mock

with open("c:/D_Drive/Stock/Codewithgoogle/StockswithDryVolume/vdu_scanner/streamlit_mock.py", "w") as f:
    f.write("""
import sys
...
spec.loader.exec_module(st_mock)

try:
    print("Running app.py...")
    import app
    print("FINISHED app.py")
    print("results:", len(st_mock.session_state.structural_vcp_results))
